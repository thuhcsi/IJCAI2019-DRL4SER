...
def get_arguments():
    ...
    parser.add_argument('--logdir', type=str, default= os.path.dirname(os.path.realpath(__file__)))
    parser.add_argument('--device', type=str, default=str(-1), help='The employed GPU ID.')
    parser.add_argument('--target_dir', type=str, default=os.path.dirname(os.path.realpath(__file__)))
